...
// Import songs
import song1 from "./static/songs/Besomorph_Silent_Child_IDGAF.mp3";
import song2 from "./static/songs/Six Feet Under - Billie Ellish.mp3";
import song3 from "./static/songs/Confetti - Ghost English Song.mp3";
import song4 from "./static/songs/Sugar And Brownies.mp3";
import song5 from "./static/songs/Love-Your-Voice(PagalWorld).mp3";
...
import Waterfall from "./static/Waterfall.png";
...
class App extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      wallpaperItems: [Rose, Waterfall, BlueJelly], //wallpapers
      songItems: [
